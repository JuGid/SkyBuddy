...
public class FollowFragment extends Fragment {
    ...
    private View view;
    private FollowRecyclerViewAdapter recyclerViewAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        RecyclerView recyclerFlight = view.findViewById(R.id.FollowRecyclerView);
        recyclerViewAdapter = new FollowRecyclerViewAdapter(getContext());
        ...
        Chloe.getFollowedByUser(getContext(),callback);
